...
public class CountryActivity extends FragmentActivity implements OnTabChangeListener, OnPageChangeListener  {
	...
	protected void onResume() {
		...
		if (mViewPager != null && pageAdapter != null) {
			...
			mViewPager.setOnPageChangeListener(CountryActivity.this);
		}
	}
	
	// Method to add a TabHost
	private static void AddTab(CountryActivity activity, TabHost tabHost,
	...
	public List<Fragment> getFragments() {
		...
		CountryFragment f0 = CountryFragment.newInstance(this.getResources().getString(R.string.country_text));
		CountryMapFragment f1 = CountryMapFragment.newInstance(this.getResources().getString(R.string.map_text));
	...
	private void initialiseTabHost() {
		...
		CountryActivity.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab0").setIndicator(this.getResources().getString(R.string.country_text)));
		CountryActivity.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab1").setIndicator(this.getResources().getString(R.string.map_text)));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_about) {
        	...
        	Intent i = new Intent(CountryActivity.this, ContinentActivity.class);
