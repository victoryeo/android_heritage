...
public class ArrayAdapterRegion extends ArrayAdapter<ClassProfile>  {
	private String TAG = "ArrayAdapterRegion";

	private Context context;
	private int layoutResourceId;
	public ArrayList<ClassProfile> region;
	private String typeSearch = "";	
	URL url;
	Bitmap bmImg;

	public ArrayAdapterRegion(Context context, int resLayout, ArrayList<ClassProfile> objects, String findType) {
	...
	public View getView(int position, View convertView, ViewGroup parent){
		...
		ClassProfile item = (ClassProfile) region.get(position);
		if(item != null){
