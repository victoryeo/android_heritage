...
public class RegionActivity extends FragmentActivity implements OnTabChangeListener, OnPageChangeListener  {
	private int HEIGHT = 62;
    private ViewPager mViewPager;
	private MyPageAdapter pageAdapter;
	private TabHost mTabHost;
	public long mContinentId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		if (extras != null) {
			mContinentId = extras.getLong("id");	
		}
		...
		if (actionBar != null) {
			...
			if (ContinentActivity.mFbUsername != null 
					&& !(ContinentActivity.mFbUsername.equals(null)) 
					&& !(ContinentActivity.mFbUsername.equals("null")))
	...
	protected void onResume() {
		...
		if (mViewPager != null && pageAdapter != null) {
			...
			mViewPager.setOnPageChangeListener(RegionActivity.this);
		}
	}
	
	// Method to add a TabHost
	private static void AddTab(RegionActivity activity, TabHost tabHost,
	...
	public List<Fragment> getFragments() {
		...
		RegionFragment f0 = RegionFragment.newInstance(this.getResources().getString(R.string.region_text));
		RegionMapFragment f1 = RegionMapFragment.newInstance(this.getResources().getString(R.string.map_text));
	...
	private void initialiseTabHost() {
		...
		RegionActivity.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab0").setIndicator(this.getResources().getString(R.string.region_text)));
		RegionActivity.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab1").setIndicator(this.getResources().getString(R.string.map_text)));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_about) {
        	...
        	Intent i = new Intent(RegionActivity.this, ContinentActivity.class);
